package com.cesi.controller.nouvelleperson.model;
import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonProperty;

public class Nouvelleperson {
    ...
    @JsonCreator
    public Nouvelleperson(@JsonProperty("id") Integer id,
    ...
    public Nouvelleperson() {
    }

    public Nouvelleperson(@JsonProperty("nom") String nom,
                          @JsonProperty("prenom") String prenom) {
        this.nom = nom;
        this.prenom = prenom;
    }
